...
from foldmind_ai_core.core.domain.models.host_actions import ActionPlan, HostAction
...
TaskOutputValue: TypeAlias = object
...
class TaskJobResult:
    result_type: str
    result: TaskOutputValue | JsonObject
